...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # 禁用 CSRF（REST API 使用 JWT）
...
# 数据库配置
# 支持PostgreSQL和MySQL，通过环境变量DB_ENGINE选择
# 开发环境默认使用SQLite，生产环境强烈建议使用PostgreSQL或MySQL
...
if DB_ENGINE == 'postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'ai_story'),
